...
public class StreamAPIProblem {
    public static void main(String[] args) {
        ...
        System.out.println("******The employeeds group by Gender******");
        method1(employeeList);
        //2. Name o f departments
    ...
    public static void  method1(List<Employee> ls){
        Map<String,Long> employees = ls.stream()
                .collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
        System.out.println(employees);
    }

    public static void method2(List<Employee> ls){
        List<String> departmentList = ls.stream()
    ...
    public static  void method3(List<Employee> ls){
        Map<String, Double> employees = ls.stream()
                .collect(Collectors.groupingBy(Employee::getGender, Collectors.averagingDouble(Employee::getAge)));
        System.out.println(employees);
    }
    public static void method4(List<Employee> ls){
        Optional<Employee> emp = ls.stream()
